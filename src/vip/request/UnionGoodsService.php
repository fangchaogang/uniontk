...
interface UnionGoodsServiceIf{
	...
	public function goodsList(\fangchaogang\uniontk\vip\request\GoodsInfoRequest $request);

	public function goodsListWithOauth(\fangchaogang\uniontk\vip\request\GoodsInfoRequest $request);

	public function healthCheck();

	public function query(\fangchaogang\uniontk\vip\request\QueryGoodsRequest $request);

	public function queryWithOauth(\fangchaogang\uniontk\vip\request\QueryGoodsRequest $request);

}

class _UnionGoodsServiceClient extends \fangchaogang\uniontk\vip\Osp\Base\OspStub implements \fangchaogang\uniontk\vip\request\UnionGoodsServiceIf{
	...
	public function send_getByGoodsIds( $goodsIdList, $requestId){
		...
		$args = new \fangchaogang\uniontk\vip\request\UnionGoodsService_getByGoodsIds_args();
	...
	public function recv_getByGoodsIds(){
		...
		$result = new \fangchaogang\uniontk\vip\request\UnionGoodsService_getByGoodsIds_result();
	...
	public function send_getByGoodsIdsWithOauth( $goodsIdList, $requestId){
		...
		$args = new \fangchaogang\uniontk\vip\request\UnionGoodsService_getByGoodsIdsWithOauth_args();
	...
	public function recv_getByGoodsIdsWithOauth(){
		...
		$result = new \fangchaogang\uniontk\vip\request\UnionGoodsService_getByGoodsIdsWithOauth_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_goodsList(\fangchaogang\uniontk\vip\request\GoodsInfoRequest $request){

		$this->initInvocation("goodsList");
		$args = new \fangchaogang\uniontk\vip\request\UnionGoodsService_goodsList_args();
	...
	public function recv_goodsList(){
		...
		$result = new \fangchaogang\uniontk\vip\request\UnionGoodsService_goodsList_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_goodsListWithOauth(\fangchaogang\uniontk\vip\request\GoodsInfoRequest $request){

		$this->initInvocation("goodsListWithOauth");
		$args = new \fangchaogang\uniontk\vip\request\UnionGoodsService_goodsListWithOauth_args();
	...
	public function recv_goodsListWithOauth(){
		...
		$result = new \fangchaogang\uniontk\vip\request\UnionGoodsService_goodsListWithOauth_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_healthCheck(){
		...
		$args = new \fangchaogang\uniontk\vip\request\UnionGoodsService_healthCheck_args();
	...
	public function recv_healthCheck(){
		...
		$result = new \fangchaogang\uniontk\vip\request\UnionGoodsService_healthCheck_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_query(\fangchaogang\uniontk\vip\request\QueryGoodsRequest $request){

		$this->initInvocation("query");
		$args = new \fangchaogang\uniontk\vip\request\UnionGoodsService_query_args();
	...
	public function recv_query(){
		...
		$result = new \fangchaogang\uniontk\vip\request\UnionGoodsService_query_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_queryWithOauth(\fangchaogang\uniontk\vip\request\QueryGoodsRequest $request){

		$this->initInvocation("queryWithOauth");
		$args = new \fangchaogang\uniontk\vip\request\UnionGoodsService_queryWithOauth_args();
	...
	public function recv_queryWithOauth(){
		...
		$result = new \fangchaogang\uniontk\vip\request\UnionGoodsService_queryWithOauth_result();
		$this->receive_base($result);
		if ($result->success !== null){
...
class UnionGoodsService_goodsList_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->request = new \fangchaogang\uniontk\vip\request\GoodsInfoRequest();
...
class UnionGoodsService_queryWithOauth_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->request = new \fangchaogang\uniontk\vip\request\QueryGoodsRequest();
			$this->request->read($input);
		...
		if(true) {
			...
			while(true){
				...
				try{
					...
					$elem0 = new \fangchaogang\uniontk\vip\request\GoodsInfo();
					$elem0->read($input);
		...
		if(true) {
			...
			while(true){
				...
				try{
					...
					$elem1 = new \fangchaogang\uniontk\vip\request\GoodsInfo();
					$elem1->read($input);
...
class UnionGoodsService_goodsList_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \fangchaogang\uniontk\vip\request\GoodsInfoResponse();
